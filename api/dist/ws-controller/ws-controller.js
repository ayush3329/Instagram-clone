...
exports.removeGroupAmdin = exports.MakeGroupAdmin = exports.changeGroupName = exports.createGroupChat = exports.HandleZeroUneenMessage = exports.HandleMessages = void 0;
...
function createGroupChat(parsedData, UserToConnection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const Group = yield Message_1.Message.create({ users: participant, groupChat: true, mainAdmin: admin, admins: [admin] });
...
function MakeGroupAdmin(parsedData, UserToConnection) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(parsedData);
        const resp = yield Message_1.Message.findByIdAndUpdate({ _id: parsedData.gid }, { $push: { admins: parsedData.fullname } }, { new: true });
        console.log("new admin-> ", resp === null || resp === void 0 ? void 0 : resp.admins);
        ...
        var size = 0;
        if ((resp === null || resp === void 0 ? void 0 : resp.admins) !== undefined) {
            size = resp.admins.length;
        }
        for (let i = 0; i < size; i++) {
            (_a = UserToConnection.get(resp === null || resp === void 0 ? void 0 : resp.admins[i])) === null || _a === void 0 ? void 0 : _a.send(JSON.stringify({ query: 'make-group-admin', packet: { success: true, newAdmin: parsedData.fullname } }));
        }
    });
}
exports.MakeGroupAdmin = MakeGroupAdmin;
function removeGroupAmdin(parsedData, UserToConnection) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        console.log("Remove group admin");
        console.log(parsedData);
        var resp = yield Message_1.Message.findById({ _id: parsedData.gid });
        const adminsList = (resp === null || resp === void 0 ? void 0 : resp.admins) || [];
        ...
        resp = yield Message_1.Message.findByIdAndUpdate({ _id: parsedData.gid }, { admins: adminsList }, { new: true });
        console.log("Updated data ", resp);
        for (let i = 0; i < ((resp === null || resp === void 0 ? void 0 : resp.users.length) || 0); i++) {
            (_a = UserToConnection.get((resp === null || resp === void 0 ? void 0 : resp.users)[i])) === null || _a === void 0 ? void 0 : _a.send(JSON.stringify({ query: "removed-as-admin", packet: { fullname: parsedData.fullname } }));
        }
    });
}
exports.removeGroupAmdin = removeGroupAmdin;
